...
//      VERIFY OTP
//   ====================== */
//   const handleVerify = async (otpVal = otp) => {
//     setError("");
...
// // const loginSuccess = (data) => {
// //   // 🔥 ALWAYS clean triggers on login
// //   localStorage.removeItem("startDashboardTour");
// //   localStorage.removeItem("startToolsTour");
...
//   ====================== */
//   const handleResend = () => {
//     if (timer === 0) handleSendOtp(new Event("submit"));
//   };
...
//           <div className="col-xxl-3 col-lg-4 d-none d-lg-block">
//             <div className="sign_in_img">
//               <img src={signImg} alt="Supplier Login" className="img-fluid w-100 rounded-4" />
//             </div>
//           </div>
...
//               <h3 className="register_title text-center">Supplier Login</h3>
